...
class CreateServiceReqMstrHist extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('service_req_mstr_hist', function (Blueprint $table) {
            ...
            $table->string('sr_action',100)->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('service_req_mstr_hist');
    }
}
