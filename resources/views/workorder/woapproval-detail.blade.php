...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-9">
            <h1 class="m-0 text-dark">Work Order Approval Detail</h1>
        </div><!-- /.col -->
    </div><!-- /.row -->
</div><!-- /.container-fluid -->
@endsection
...
<div class="row">
    <form class="form-horizontal newedit" id="newedit" method="post" action="/approvewo" enctype="multipart/form-data">
        ...
        <div class="modal-body">
                        ...
                        <tbody id='detailapp_ins'>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle; text-align: left;">
                                    ...
                                    <input type="hidden" class="stepdesc" name="stepdesc[]" value="{{$datains->wd_ins_stepdesc}}" readonly />
                                </td>
                                <td style="vertical-align:middle;text-align:right;">
                                    <div class="input-group">
                                        <input type="number" min="0" step="0.01" class="form-control ins_duration" name="ins_duration[]" value="{{$datains->wd_ins_duration != null ? $datains->wd_ins_duration : ''}}" readonly>
                                        <div class="input-group-append">
                                            <span class="input-group-text" id="basic-addon2"> {{$datains->um_desc}} </span>
                                            <input type="hidden" name="durationum[]" value="{{$datains->um_code}}" readonly />
                                        </div>
                                    </div>
                                </td>
                                <td style="vertical-align:middle;text-align:right; max-width: 100px !important;">
                                    <!-- <input type="text" class="form-control ins_list_eng" name="ins_list_eng[{{$index}}][option][]" value="{{$datains->wd_ins_engineer}}" readonly /> -->
                                    <select class="form-control ins_list_eng" name="ins_list_eng[{{$index}}][option][]" multiple data-live-search="true" data-max-options="5" data-size="3" data-dropup-auto="false" disabled>
                    ...
                    <table id="createTableQc" class="table table-bordered order-list" width="100%" cellspacing="0">
                        ...
                        <tbody id='detailapp_qc'>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle; text-align: left;">
                                    <input type="text" class="form-control resultqc1" name="resultqc1[]" value="{{$dataqc->wd_qc_result1 != null ? $dataqc->wd_qc_result1 : ''}}" maxlength="250" readonly />
                                </td>
                            </tr>
            ...
            <div style="border: 1px solid black; margin-top: 5% !important; padding-top: 5%; padding-bottom: 5%; padding-left: 5%; padding-right: 5%;">
                <div class="form-group row col-md-12">
                    <label for="c_finishdate" class="col-md-4 col-form-label text-md-left">Finish Date</label>
                    <div class="col-md-3">
                        <input id="c_finishdate" type="date" class="form-control c_finishdate" name="c_finishdate" value="{{($header->wo_job_finishdate != null) ? $header->wo_job_finishdate : \Carbon\Carbon::now()->format('Y-m-d')}}" readonly>
                    </div>
                </div>
                <div class="form-group row col-md-12">
                    <label for="c_finishtime" class="col-md-4 col-form-label text-md-left">Finish Time</label>
                    <div class="col-md-3">
                        <input type="time" class="form-control" name="c_finishtime" value="{{($header->wo_job_finishtime != null) ? $header->wo_job_finishtime : \Carbon\Carbon::now()->format('H:i')}}" readonly />
                    </div>
                </div>
                ...
                <div class="form-group row col-md-12">
                    ...
                    <div class="col-md-5 col-sm-12">
                        ...
                        <select class="form-control" id="failurecode" name="failurecode[]" multiple="multiple" disabled>
                            <option></option>
                ...
                <div class="form-group row col-md-12">
                    <label for="downtime" class="col-md-4 col-form-label text-md-left">Downtime</label>
                    <div class="col-md-3">
                        <input type="number" id="downtime" min="0" class="form-control" name="downtime" value="{{$header->wo_downtime != null ? $header->wo_downtime : ''}}" readonly />
                    </div>
                    <div class="col-md-3">
                        <select class="form-control" id="downtime_um" name="downtime_um" disabled>
                ...
                <div class="form-group row col-md-12">
                    <label for="c_note" class="col-md-4 col-form-label text-md-left">Reporting Note</label>
                    <div class="col-md-6">
                        <textarea id="c_note" class="form-control c_note" name="c_note" maxlength="250" readonly>{{($header->wo_report_note != null) ? $header->wo_report_note  : ''}}</textarea>
                    </div>
                </div>
