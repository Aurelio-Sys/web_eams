...
<div class="container-fluid">
  <div class="row mb-2">
    <div class="col-sm-9 mt-2">
      ...
      <p class="pb-0 m-0">Menu ini berfungsi untuk pelaporan hasil pengerjaan work order oleh engineer</p>
    </div><!-- /.col -->
    <div class="col-sm-3">
        ...
        <form class="form-horizontal" id="newedit" method="post" action="/reportingwo">
          ...
          <div class="modal-body">
            ...
            <div class="form-group row col-md-12">
              ...
              <div class="col-md-6">
                <textarea id="c_note" class="form-control c_note" name="c_note" autofocus required></textarea>
              </div>
            </div>
