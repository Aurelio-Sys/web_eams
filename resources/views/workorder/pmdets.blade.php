...
@section('content-header')
      <div class="container-fluid">
        ...
        <div class="row">                 
          <div class="col-sm-2">    
            <form class="form-horizontal" method="get" action="/newpmdets">
                {{ csrf_field() }}

                <button type="submit" class="btn btn-block btn-primary">PM Details Create</button>
            </form>
          </div><!-- /.col -->  
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center" id="exampleModalLabel">PM Details Create</h5>
            ...
            <form class="form-horizontal" method="post" action="/createapmdets">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="t_code" class="col-md-2 col-form-label text-md-right">Asset Code</label>
                        <div class="col-md-8">
