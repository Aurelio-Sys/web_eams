            ...
            <div class="form-group row">
                <div class="col-md-12">
                    <table id="createTable" class="table table-bordered order-list" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <td style="text-align: center; width: 30% !important;">Spare Part</td>
                                <td style="text-align: center; width: 15% !important;">Qty Req.</td>
                                <td style="text-align: center; width: 15% !important;">Qty to Request</td>
                                <td style="text-align: center; width: 10% !important;">Delete</td>
                            </tr>
                        </thead>
                        <tbody id='detailapp'>
                            <tr>
...
<script type="text/javascript">
    ...
    $("#addrow").on("click", function() {
        ...
        cols += '<td>';
        cols += '<input type="text" class="form-control spcode" name="spcode[]" required />';
        cols += '</td>';
