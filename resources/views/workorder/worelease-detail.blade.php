                ...
                <div class="table-responsive tag-container" style="overflow-x: auto; display:inline-block; white-space: nowrap; padding:0; text-align:center; position:relative">
                    <table id="createTable" class="table table-bordered order-list" width="100%" cellspacing="0">
                        ...
                        <tbody id='detailapp'>
                            ...
                            <tr>
                                <td>
                                    <select name="spreq[]" style="display: inline-block !important;" class="form-control selectpicker" data-live-search="true" data-dropup-auto="false" data-size="4" data-width="200px" required>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $("#addrow").on("click", function() {
            ...
            cols += '<td style="vertical-align:middle;text-align:left;">';
            cols += '<select name="spreq[]" style="display: inline-block !important;" class="form-control selectpicker" data-live-search="true" data-dropup-auto="false" data-size="4" data-width="350px" required>';
        ...
        $(document).on('click', '.viewstok', function() {
            ...
            $.ajax({
                ...
                success: function(vamp) {
                    ...
                    const headerColumns = ["Part", "Site", "Location", "Lot", "Quantity"];
