    ...
    <div class="row">
        <div class="col-md-3 p-2">
            ...
            <a href="{{ route('trainSetup') }}" class="card-link">
                <div class="card" style="border-radius: 50px; height: 25rem;">
                    <div class="card-body">
                        <h3 class="card-text text-center font-weight-bold">SETUP</h3>
                    </div>
                    <img class="card-img" style="border-radius: 50px;" src="{{asset('images/setup-pic.png')}}" width="100" alt="Card image cap">
                </div>
            </a>
        </div>
        <div class="col-md-3 p-2">
            ...
            <a href="{{ route('trainPlan') }}" class="card-link">
                <div class="card" style="border-radius: 50px; height: 25rem;">
                    ...
                    <img class="card-img" style="border-radius: 50px;" src="{{asset('images/plan-pic.png')}}" width="100" alt="Card image cap">
                </div>
            </a>
        </div>
        <div class="col-md-3 p-2">
            ...
            <a href="{{ route('trainExecute') }}" class="card-link">
                <div class="card" style="border-radius: 50px; height: 25rem;">
                    ...
                    <img class="card-img" style="border-radius: 50px;" src="{{asset('images/execute-pic.png')}}" width="100" alt="Card image cap">
                </div>
            </a>
        </div>
        <div class="col-md-3 p-2">
            ...
            <a href="{{ route('trainAnalyze') }}" class="card-link">
                <div class="card" style="border-radius: 50px; height: 25rem;">
                    ...
                    <img class="card-img" style="border-radius: 50px;" src="{{asset('images/analyze-pic.png')}}" width="100" alt="Card image cap">
                </div>
            </a>
        </div>
    </div>
