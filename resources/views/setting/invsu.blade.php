    ...
    <div class="collapse" id="collapseExample">
        ...
        <div class="card card-body bg-black rounded-0">
            <div class="col-12 form-group row">
                ...
                <label for="s_desc" class="col-md-2 col-sm-2 col-form-label text-md-right">Source Site</label>
                <div class="col-md-4 col-sm-4 mb-2 input-group">
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" action="/createinvsu">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="t_desc" class="col-md-3 col-form-label text-md-right">Source Site</label>
                        <div class="col-md-6">
