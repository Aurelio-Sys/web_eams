...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-2">
            <form action="/loadsparepart" method="post" id="submit">
                {{ method_field('post') }}
                {{ csrf_field() }}
            ...
            <form class="form-horizontal" method="post" action="/createspm">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="t_lot" type="text" class="form-control" name="t_lot" autocomplete="off" autofocus />
                        </div>
                    </div>
                    <div class="form-group row">
            ...
            <form class="form-horizontal" method="post" action="/editspm">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="te_lot" type="text" class="form-control" name="te_lot" autocomplete="off" autofocus />
                        </div>
                    </div>
                    <div class="form-group row">
