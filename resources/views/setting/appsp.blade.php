...
@section('content-header')
      <div class="container-fluid">
        <div class="row">          
          <div class="col-sm-4">
            <h1 class="m-0 text-dark">Approval Sparepart Transfer</h1>
          </div>    
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
@endsection
...
@section('scripts')
    <script>
        ...
        $("#ed_addrow").on("click", function() {
          ...
          cols += '<td width="30%"><input type="hidden" name="te_id[]"><input type="number" class="form-control" name="te_seq[]" min="0"></td>';
          cols += '<td width="50%">';
          cols += '<select id="te_role" class="form-control te_role" name="te_role[]" data-live-search="true" required>';
