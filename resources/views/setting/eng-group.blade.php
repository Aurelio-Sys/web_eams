...
@section('content-header')
      <div class="container-fluid">
        <div class="row">          
          <div class="col-sm-4">
            <h1 class="m-0 text-dark">Engineer Group Maintenance</h1>
          </div>    
        </div><!-- /.row -->
        <div class="col-md-12">
          <hr>
        ...
        <div class="row">                 
          <div class="col-sm-2">    
            <button class="btn btn-block btn-primary" data-toggle="modal" data-target="#createModal">Engineer Group Create</button>
          </div><!-- /.col -->  
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
@endsection
...
<div class="table-responsive col-12">
    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        <thead>
            <tr>
                <th width="15%">Engineer Group Code</th>
                <th width="25%">Engineer Group Desc</th>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center" id="exampleModalLabel">Engineer Group Create</h5>
            ...
            <form class="form-horizontal" method="post" action="/createegr">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="t_code" class="col-md-4 col-form-label text-md-right">Engineer Group Code</label>
                        <div class="col-md-2">
                            <input type="text" class="form-control" id="t_code" name="t_code" autocomplete="off" maxlength="24" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="t_code" class="col-md-4 col-form-label text-md-right">Engineer Group Desc</label>
                        <div class="col-md-6">
