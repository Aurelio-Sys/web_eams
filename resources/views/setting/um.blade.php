...
@section('content-header')
        ...
        <div class="row">          
          <div class="col-sm-4">
            <h1 class="m-0 text-dark">UM Maintenance</h1>
          </div>    
        </div><!-- /.row -->
        <div class="col-md-12">
          <hr>
        ...
        <div class="row">                 
          <div class="col-sm-2">    
            <button class="btn btn-block btn-primary" data-toggle="modal" data-target="#createModal">UM Create</button>
          </div><!-- /.col -->  
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
@endsection
...
<div class="table-responsive col-12">
    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
            <!-- untuk isi table -->
            @include('setting.table-um')
        </tbody>
    </table>
    <input type="hidden" name="hidden_page" id="hidden_page" value="1"/>
    <input type="hidden" name="hidden_column_name" id="hidden_column_name" value="um_code"/>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center" id="exampleModalLabel">UM Create</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form class="form-horizontal" method="post" action="/createum">
                {{ csrf_field() }}
...
<div class="modal fade" id="editModal" role="dialog" aria-hidden="true" data-backdrop="static">
    ...
    <div class="modal-content">
        <div class="modal-header">
        <h5 class="modal-title text-center" id="exampleModalLabel">UM Modify</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
        </div>
        <form class="form-horizontal" method="post" action="/editum">
            {{ csrf_field() }}
            <div class="modal-body">
                <div class="form-group row">
...
<div class="modal fade" id="deleteModal" role="dialog" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title text-center" id="exampleModalLabel">UM Delete</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
            </div>
            <form class="form-horizontal" method="post" action="/deleteum">
                {{ csrf_field() }}
                <div class="modal-body">
    ...
    <script>
       ...
       function clear_icon()
       {
        ...
        $(document).on('change','#t_code',function(){
            ...
            $.ajax({
              url: "/cekum?code=" + code + "&desc=" + desc,
              success: function(data) {
                
                if (data == "ada") {
                  alert("UM Already Registered!!");
        ...
        $(document).on('change','#t_desc',function(){
            ...
            $.ajax({
              ...
              success: function(data) {
                ...
                if (data == "ada") {
                  alert("Description UM Already Registered!!");
