...
-->
  ...
  @foreach($engineerlist as $el)
    ...
    <tr>
      <td style="font-family:sans-serif;text-align:center;height:20px">
        <p style="margin: 0px"><b>Engineer</b></p>
      </td>
      <td style="font-family:sans-serif;text-align:center;height:20px">
        <p style="margin: 0px"><b>Reviewer</b></p>
      </td>
      <td style="font-family:sans-serif;text-align:center;height:20px">
        <p style="margin: 0px"><b>Approver</b></p>
      </td>
...
-->
    ...
    <tr>
      <td style="font-family:sans-serif;text-align:left;height:20px">
        <p style="margin: 0px"><b>Tgl : </b> {{-- {{date('d-m-Y',strtotime($data[0]->wo_created_at))}} --}}</p>
      </td>
      {{-- @if($data[0]->wo_reviewer_appdate != null) --}}
      <td style="font-family:sans-serif;text-align:left;height:20px">
        <p style="margin: 0px"><b>Tgl : </b> {{-- {{date('d-m-Y',strtotime($data[0]->wo_reviewer_appdate))}} --}}</p>
      </td>
      {{-- @else --}}
    ...
    @if($data[0]->wo_approver_appdate != null) --}}
      <td style="font-family:sans-serif;text-align:left;height:20px">
        <p style="margin: 0px">
          <b>Tgl : </b>
          {{-- {{date('d-m-Y',strtotime($data[0]->wo_approver_appdate))}} --}}
        </p>
      </td>
      {{-- @else --}}
      <!-- <td style="font-family:sans-serif;text-align:left;height:20px">
