                ...
                <div class="form-group row">
                    ...
                    <form action="{{ route('saveFavMenu') }}" method="post">
                        ...
                        @if ($isFav)
                            ...
                            <input type="hidden" name="menu_name" value="Service Request Create">
...
@section('content')
    ...
    <div class="panel-body">
        ...
        <form method="post" id="srform" action="/inputsr" style="background-color: white; padding: 2%;"
            ...
            {{ csrf_field() }}
            <div class="form-group row">
                <label for="assetloc" class="col-md-2 col-lg-3 col-form-label my-auto">Asset Location <span id="alert1"
                ...
                <div class="col-md-5 col-sm-12">
                    <select id="assetloc" name="assetloc" class="form-control" required>
                        ...
                        @foreach ($assetloc as $show)
                            <option value="{{ $show->asloc_code }}">{{ $show->asloc_code . ' -- ' . $show->asloc_desc }}
                            </option>
                        @endforeach
                    </select>
                </div>
            ...
            <div class="form-group row">
                <label for="assetcode" class="col-md-2 col-lg-3 col-form-label my-auto">Asset <span id="alert1"
                        style="color: red; font-weight: 200;">*</span></label>
                <div class="col-md-5 col-sm-12">
                ...
                <div class="col-md-5 col-sm-12">
                    <select class="form-control" id="wotype" name="wotype">
                        ...
                        @foreach ($wotype as $wotypeshow)
                            <option value="{{ $wotypeshow->wotyp_code }}">{{ $wotypeshow->wotyp_code }} --
                                {{ $wotypeshow->wotyp_desc }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
    ...
    @endforeach
            ...
            <div class="form-group row">
                <label class="col-sm-12 col-lg-3 col-form-label">Note <span id="alert1"
                        style="color: red; font-weight: 200;">*</span></label>
                <div class="col-sm-12 col-md-5">
                    <textarea type="text" class="form-control" id="notesr" name="notesr" maxlength="250" autocomplete="off"
                        required></textarea>
                </div>
            </div>
            <div class="form-group row">
    ...
    @endforeach
            ...
            <div class="form-group row">
                <label for="t_app" class="col-md-2 col-lg-3 col-form-label my-auto">Engineer Approver <span
