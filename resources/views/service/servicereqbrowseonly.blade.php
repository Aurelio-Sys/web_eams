...
<div class="container-fluid">
  <div class="row mb-2">
    <div class="col-sm-6 mt-2">
      ...
      <p class="pb-0 m-0">Menu ini berfungsi untuk melihat view detail tanpa melakukan transaksi apapun</p>
    </div><!-- /.col -->
  </div><!-- /.row -->
</div><!-- /.container-fluid -->
<!-- <hr> -->
...
<div class="table-responsive col-12">
  <table class="table table-bordered mt-4 no-footer mini-table" id="dataTable" width="100%" cellspacing="0">
    ...
    <tbody>
      @include('service.table-srbrowseonly')
    </tbody>
  </table>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    function fetch_data(page, srnumber, asset, /*priority /*period*/ status, requestby, datefrom, dateto) {
      $.ajax({
        url: "/srbrowseonly/searchsr?page=" + page + "&srnumber=" + srnumber + "&asset=" + asset + /*"&priority=" + priority + /* "&period=" + period + */ "&status=" + status + "&requestby=" + requestby + "&datefrom=" + datefrom + "&dateto=" + dateto,
    ...
    $(document).on('click', '#btnexcel', function() {
      ...
      window.open("/donlodsrbrowse?srnumber=" + srnumber + "&asset=" + srasset + "&status=" + srstatus + /*"&priority=" + srpriority + "&period=" + srperiod +*/ "&reqby=" + srreq + "&datefrom=" + srdatefrom + "&dateto=" + srdateto, '_blank');
    });
  });
</script>
@endsection