        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group row">
                    <h1 class="m-0 p-0 text-dark">Service Request</h1>
                    &nbsp;
                    &nbsp;
                    <form action="{{ route('saveFavMenu') }}" method="post">
                        ...
                        @method('post')
                        @if ($isFav)
                            <input type="hidden" name="d_id" value="{{ $isFav->id }}">
                            <input type="hidden" name="favAction" value="delete">
                            <input type="hidden" name="menu_name" value="Service Request">
                            <input type="hidden" name="menu_url" value="{{ Request::path() }}">
                            <input type="hidden" name="menu_icon" value="fas fa-star">
                            <button type="submit" style="border: none;background: #f4f6f9;">
                                <i class="fas fa-star fa-2x" style="color: #f0d942;"></i>
                            </button>
                        @else
                            <input type="hidden" name="favAction" value="add">
                            <input type="hidden" name="menu_name" value="Service Request">
                            <input type="hidden" name="menu_url" value="{{ Request::path() }}">
                            <input type="hidden" name="menu_icon" value="far fa-star">
                            <button type="submit" style="border: none;background: #f4f6f9;">
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="container-fluid mb-1">
                <div class="row">
                    <div class="col-md-12">
                        <button type="button" class="btn btn-block bg-black rounded-0" data-toggle="collapse"
                            data-target="#collapseExample" style="font-weight: bolder;">Click Here To Search</button>
                    </div>
                </div>
                ...
                <div class="collapse" id="collapseExample">
                    ...
                    <div class="card card-body bg-black rounded-0">
                        <div class="col-12 form-group row">
                            <!--FORM Search Disini-->
                            <label for="s_servicenbr"
                                class="col-md-3 col-sm-2 col-form-label text-md-left">{{ __('Service Request Number') }}</label>
                            <div class="col-md-3 col-sm-4 mb-2 input-group">
                                <input id="s_servicenbr" type="text" class="form-control" name="s_servicenbr"
                                    value="" autofocus autocomplete="off" placeholder="Search SR Number">
                            </div>
                            <label for="s_asset"
                                class="col-md-2 col-sm-2 col-form-label text-md-right">{{ __('Asset Description') }}</label>
                            <div class="col-md-3 col-sm-4 mb-2 input-group">
    ...
    @endforeach
                                ...
                                <input id="s_asset" type="text" class="form-control" name="s_asset" value=""
                                    autofocus autocomplete="off" placeholder="Search Asset Desc">
                            </div>
                        </div>
                        <div class="col-12 form-group row">
                            <label for="s_status"
                                class="col-md-3 col-sm-2 col-form-label text-md-left">{{ __('Status') }}</label>
                            <div class="col-md-3 col-sm-4 mb-2 input-group">
                                <select id="s_status" name="s_status" class="form-control" value="" autofocus
                                    autocomplete="off">
                  ...
                  <div class="col-md-3 col-sm-4 mb-2 input-group">
                    <select id="s_period" name="s_period" class="form-control" value="" autofocus autocomplete="off">
                      ...
                      <option value="3"> > 5 days </option>
                            ...
                            <label for="s_user"
                                class="col-md-2 col-sm-2 col-form-label text-md-right">{{ __('Requested by') }}</label>
                            <div class="col-md-3 col-sm-4 mb-2 input-group">
                                <select id="s_user" name="s_user" class="form-control" value="" autofocus
                                    autocomplete="off">
                                    <option value="">--Select User--</option>
                                    @foreach ($users as $usershow)
                                        <option value="{{ $usershow->username }}">{{ $usershow->username }} -
                                            {{ $usershow->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-12 form-group row">
                            <label for="s_datefrom"
                                class="col-md-3 col-sm-2 col-form-label text-md-left">{{ __('Date from') }}</label>
                            <div class="col-md-3 col-sm-4 mb-2 input-group">
                                <input type="text" id="s_datefrom" class="form-control" name='s_datefrom'
                                    placeholder="YYYY-MM-DD" required autofocus autocomplete="off">
                            </div>
                            <!-- <label for="s_priority" class="col-md-3 col-sm-2 col-form-label text-md-left">{{ __('Priority') }}</label>
            <div class="col-md-3 col-sm-4 mb-2 input-group">
              <select id="s_priority" name="s_priority" class="form-control" value="" autofocus autocomplete="off">
                  ...
                  <div class="col-md-3 col-sm-4 mb-2 input-group">
                    <select id="s_period" name="s_period" class="form-control" value="" autofocus autocomplete="off">
                      ...
                      <option value="3"> > 5 days </option>
                            ...
                            <label for="s_dateto"
                                class="col-md-2 col-sm-2 col-form-label text-md-right">{{ __('Date to') }}</label>
                            <div class="col-md-3 col-sm-4 mb-2 input-group">
                                <input type="text" id="s_dateto" class="form-control" name='s_dateto'
                                    placeholder="YYYY-MM-DD" required autofocus autocomplete="off">
                            </div>
                        </div>
                        <div class="col-12 form-group row">
...
@else
    ...
    @endif
                ...
                <option value="8">Reprocess</option>
                            ...
                            <div class="col-md-6 col-sm-4 mb-2 input-group">
                                <input type="button" class="btn btn-primary col-md-3" id="btnsearch" value="Search"
                                    style="float:right" />
                                &nbsp;&nbsp;&nbsp;
                                <button type="button" class="btn btn-primary col-md-2" id="btnrefresh"><i
                                        class="fas fa-redo-alt"></i></button>
                                &nbsp;&nbsp;&nbsp;
                                <input type="button" class="btn btn-primary col-md-4" id="btnexcel"
                                    value="Export to Excel" style="float:right" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="table-responsive col-lg-12 col-md-12 tag-container"
                style="overflow-x: auto;overflow-y: hidden ;display: inline-block;white-space: nowrap; position:relative;">
                ...
                <form class="form-horizontal" id="newedit" method="post" action="editsr"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row justify-content-center" style="display: none;">
                            ...
                            <div class="col-md-7">
                                <input id="e_nowo" type="text" class="form-control" name="e_nowo"
                                    autocomplete="off" maxlength="6" readonly>
                            </div>
                        </div>
                        <div class="form-group row justify-content-center">
                            <label for="e_req" class="col-md-5 col-form-label text-md-left">Request By</label>
                            <div class="col-md-7">
                                <input id="e_req" type="text" class="form-control" name="e_req"
                                    autocomplete="off" maxlength="6" readonly>
                            </div>
                        </div>
                        <div class="form-group row justify-content-center">
                            ...
                            <div class="col-md-7">
                                <input id="e_dept" type="text" class="form-control" name="e_dept"
                                    autocomplete="off" maxlength="6" readonly>
                            </div>
                        </div>
                        <div class="form-group row justify-content-center">
                            ...
                            <div class="col-md-7">
                                <input id="e_status" type="text" class="form-control" name="e_status"
                                    autocomplete="off" maxlength="6" readonly style="color:green;font-weight:bold">
                            </div>
                        </div>
                        <div class="form-group row justify-content-center">
                            <label for="e_reason" class="col-md-5 col-form-label text-md-left">Approval Reason</label>
                            <div class="col-md-7">
                                <textarea id="e_reason" type="text" class="form-control" name="e_reason" autocomplete="off" rows="3"
                                    readonly></textarea>
                            </div>
                        </div>
                        <div class="form-group row justify-content-center">
                            ...
                            <div class="col-md-7">
                                ...
                                <input id="e_assethid" type="hidden" class="form-control e_asset" name="e_asset"
                                    readonly>
                                <input id="e_asset" type="text" class="form-control" name="e_asset"
                                    autocomplete="off" maxlength="6" readonly>
                            </div>
                        </div>
                        <div class="form-group row justify-content-center">
                            ...
                            <div class="col-md-7">
                                ...
                                <select id="e_wottype" name="e_wottype" class="form-control e_wottype">
                                    ...
                                    @foreach ($wotype as $show)
                                        <option value="{{ $show->wotyp_code }}">{{ $show->wotyp_code }} --
                                            {{ $show->wotyp_desc }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group row justify-content-center">
                            ...
                            <div class="col-md-7 col-sm-12">
                                <select class="form-control" id="e_failurecode" name="e_failurecode[]"
                                    multiple="multiple">
                                    <option></option>
                                    @foreach ($fcode as $fcshow)
                                        <option value="{{ $fcshow->fn_code }}">{{ $fcshow->fn_code }} --
                                            {{ $fcshow->fn_desc }} -- {{ $fcshow->fn_impact }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group row justify-content-center e_impactdiv" id="e_impactdiv">
                            ...
                            <div class="col-md-7">
                                <select id="e_impact" class="form-control e_impact" name="e_impact[]"
                                    multiple="multiple">
                                    @foreach ($impact as $impactshow)
                                        <option value="{{ $impactshow->imp_code }}">{{ $impactshow->imp_code }} --
                                            {{ $impactshow->imp_desc }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-md-7">
                                <select id="e_approver" name="e_approver" class="form-control" required>
                                    ...
                                    @foreach ($dataapp as $da)
                                        <option value="{{ $da->eng_dept }}">{{ $da->eng_dept . ' -- ' . $da->dept_desc }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
    ...
    <div class="modal fade" id="cancelModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                ...
                <form class="form-horizontal" id="newcancel" method="post" action="cancelsr"
                    enctype="multipart/form-data">
                    {{ csrf_field() }}

                    <div style="display: none;">
                        <label for="c_srnumber"
                            class="col-md-4 col-form-label text-md-right">{{ __('SR Number') }}</label>
                        <div class="col-md-7">
                            <input id="c_srnumber" type="text" class="form-control" name="c_srnumber" value=""
                                readonly>
                        </div>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <label class="col-md-12 col-form-label">If you are sure, please fill the cancelation reason <span
    ...
    <!-- Modal Route -->
    <div class="modal fade" id="routeModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-md-12">
                        <div class="form-group row">
                            <label for="ppnumber"
                                class="col-2 col-sm-2 col-md-2 col-lg-2 col-form-label text-sm-center">{{ __('SR No.') }}</label>
                            <div class="col-4 col-sm-4 col-md-4 col-lg-4">
                                <input type="text" class="form-control" id="m_route_ppnumber" readonly>
                            </div>
                            <label for="requestedBy"
                                class="col-2 col-sm-2 col-md-2 col-lg-2 col-form-label text-sm-center">{{ __('Requested By') }}</label>
                    ...
                    <div class="col-md-12">
                        <div class="form-group row">
                            <label for="site"
                                class="col-2 col-sm-2 col-md-2 col-lg-2 col-form-label text-sm-center">{{ __('Asset') }}</label>
                            <div class="col-4 col-sm-4 col-md-4 col-lg-4">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input id="wostatus" type="text" class="form-control" name="wostatus"
                                style="font-weight: bold;" readonly />
                        </div>
                        <label for="sr_impact" class="col-md-2 col-form-label">Impact</label>
                        <div class="col-md-4">
                            <textarea id="sr_impact" type="text" class="form-control" name="sr_impact" autocomplete="off" rows="3"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input id="srdate" type="text" class="form-control" name="srdate" autocomplete="off"
                                readonly />
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input id="srtime" type="text" class="form-control" name="srtime" autocomplete="off"
                                readonly />
                        </div>
                    </div>
                    <div class="form-group row">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function fetch_data(page, srnumber, asset, /*priority /*period*/ status, requestby, datefrom, dateto) {
                $.ajax({
                    url: "/srbrowse/searchsr?page=" + page + "&srnumber=" + srnumber + "&asset=" + asset +
                        /*"&priority=" + priority + /* "&period=" + period + */ "&status=" + status +
                        "&requestby=" + requestby + "&datefrom=" + datefrom + "&dateto=" + dateto,
            ...
            $(document).on('click', '#btnsearch', function() {
                ...
                fetch_data(page, srnumber, asset, /*priority*/ /*period*/ status, requestby, datefrom,
                    dateto);
            ...
            $(document).on('click', '#btnexcel', function() {
                ...
                window.open("/donlodsr?srnumber=" + srnumber + "&asset=" + srasset + "&status=" + srstatus +
                    /*"&priority=" + srpriority + "&period=" + srperiod +*/ "&reqby=" + srreq +
                    "&datefrom=" + srdatefrom + "&dateto=" + srdateto, '_blank');
            });
        });
    </script>
@endsection
