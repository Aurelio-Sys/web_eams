...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-9">
      <h1 class="m-0 text-dark">Parent Cost Report</h1>
    </div><!-- /.col -->
    <div class="col-sm-3">
  ...
  <div class="collapse" id="collapseExample">
      ...
      <div class="card card-body bg-black rounded-0">
        <div class="col-12 form-group row">
          ...
          <label for="s_par" class="col-md-2 col-form-label text-md-right">{{ __('Parent Asset') }}</label>
          <div class="col-md-4 col-sm-12 mb-2 input-group">
            <select id="s_par" class="form-control" style="color:black" name="s_par" autofocus autocomplete="off">
              <option value="">--Select Parent Asset--</option>
              @foreach($datapar as $parsearch)
                <option value="{{$parsearch->aspar_par}}" {{$parsearch->aspar_par === $spar ? "selected" : ""}}>{{$parsearch->aspar_par}} -- {{$parsearch->asset_desc}}</option>
              @endforeach
            </select>
          </div>
