...
<tr>
    ...
    <td>
        ...
        data-loc="{{$show->asset_loc}}" data-locdesc="{{$show->asloc_desc}}" data-um="{{$show->asset_um}}" data-sn="{{$show->asset_sn}}" 
        data-prc_date="{{$show->asset_prcdate}}" data-prc_price="{{$show->asset_prcprice}}" data-type="{{$show->asset_type}}" data-typedesc="{{$show->astype_desc}}" 
        data-group="{{$show->asset_group}}"  data-groupdesc="{{$show->asgroup_desc}}" data-supp="{{$show->asset_supp}}" data-note="{{$show->asset_note}}" 
