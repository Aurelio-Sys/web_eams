...
<tr>
    ...
    <!-- view -->
        <a class="viewreqsp" href="javascript:void(0)" type="button" data-toggle="tooltip" title="View Request Sparepart" 
        data-rsnumber="{{ $datas->req_sp_number }}" data-wonumber="{{ $datas->req_sp_wonumber }}" data-reqby="{{ $datas->req_sp_requested_by }}" data-duedate="{{ $datas->req_sp_due_date == '0000-00-00' ? '' : date('m/d/Y', strtotime($datas->req_sp_due_date)) }}"
    ...
    <!-- edit -->
        ...
        <a class="editreqsp" href="javascript:void(0)" type="button" data-toggle="tooltip" title="Edit Request Sparepart"
        data-rsnumber="{{ $datas->req_sp_number }}" data-wonumber="{{ $datas->req_sp_wonumber }}" data-reqby="{{ $datas->req_sp_requested_by }}" data-duedate="{{ $datas->req_sp_due_date == '0000-00-00' ? '' : $datas->req_sp_due_date }}"
        data-trfby="{{ $datas->req_sp_transfered_by }}" data-trfdate="{{ $datas->req_sp_transfer_date == '0000-00-00' ? '' : date('m/d/Y', strtotime($datas->req_sp_transfer_date)) }}" data-status="{{ $datas->req_sp_status }}"
        data-spcode="{{ $datas->req_spd_sparepart_code }}" data-spdesc="{{ $datas->spm_desc }}" data-qtyreq="{{ $datas->req_spd_qty_request }}" data-qtytrf="{{ $datas->req_spd_qty_transfer }}"
