...
<tr>
    ...
    <td style="text-align: center;">
        ...
        <!-- edit -->
        @if($datas->req_sp_status == 'open' && $datas->req_sp_requested_by == session('username') && $datas->rqtr_status != 'approved')
        ...
        @if($datas->req_sp_status != 'open' && $datas->req_sp_status != 'canceled')
