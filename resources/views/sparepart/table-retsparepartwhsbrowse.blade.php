...
<tr>
    ...
    data-rsnumber="{{ $datas->ret_sp_number }}" data-retby="{{ $datas->ret_sp_return_by}}" data-duedate="{{ $datas->created_at == '0000-00-00' ? '' : date('m/d/Y', strtotime($datas->created_at)) }}"
    ...
    data-locfrom="{{ $datas->ret_spd_loc_from }}" data-sitefrom="{{ $datas->ret_spd_site_from }}" data-lotfrom="{{ $datas->ret_spd_lot_from }}" data-locto="{{ $datas->ret_spd_loc_to }}" data-siteto="{{ $datas->ret_spd_site_to }}" data-note="{{ $datas->ret_spd_engnote }}"
