...
<body>
    <div class="container" style="font-family: Arial, sans-serif; background-color: #f2f2f2; padding: 20px;">
        <div class="header" style="background-color: #333; color: #fff; padding: 10px;">
            <h1 style="margin: 0; text-align: center;">Work Order Spare Part Transfer</h1>
        </div>
        <div class="content" style="background-color: #fff; padding: 20px;">
            <p style="font-size: 16px;">Dear User,</p>
            <p style="font-size: 16px;">We would like to inform you that the spare parts for work order number <strong>{{$wonumber}}</strong> have been transferred by the warehouse.</p>
