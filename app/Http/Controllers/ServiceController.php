...
class ServiceController extends Controller
{
    ...
    public function srapprovaleng(Request $req) /* blade : service.servicereq-approval */
    {
        ...
        if ($kepalaengineer) {
            ...
            if ($engineer_approver != null) {
                ...
                wotyp_mstr.*,users.*,dept_mstr.*,service_req_mstr.id,wo_mstr.*,
                srta_eng_status,eng_role,srta_eng_reason')
                    ->where('sr_status', '<>', 'Canceled')
                    // ->where('sr_status', '<>', 'Inprocess')
    ...
    public function routesreng(Request $request)
    {
        ...
        $dataApprover = DB::table('sr_trans_approval_eng')
            ...
            ->join('roles', 'sr_trans_approval_eng.srta_eng_role_approval', '=', 'roles.role_code')
