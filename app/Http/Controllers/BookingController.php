        ...
        if ($req->ajax()) {
            ...
            if ($code == '' && $asset == '' && $status == '') {
                ...
                if ($code != '') {
                    ...
                    $data->where('book_code', 'like' ,'%' . $code . '%');
                }
                if ($asset != '') {
                    // if ($kondisi != '') {
                        // $kondisi .= " and book_asset like '%" . $asset . "%'";
                        $data->where('book_asset','like','%'.$asset.'%');
                    // } else {
                ...
                if ($status != '') {
                    ...
                    // } else {
                        ...
                        $data->where('book_status','like','%'.$status.'%');

                    // }
                }
                //dd($kondisi);

                $data = $data->orderBy('book_id', 'desc')->paginate(10);
