...
class wocontroller extends Controller
{
    ...
    public function openprint(Request $req, $wo)
    {
        ...
        $pdf = PDF::loadview('workorder.pdfprint-template', ['sparepart' => $sparepartarray, 'womstr' => $womstr, 'repairlist' => $repairlist, 'data' => $data, 'repair' => $repair, 'counter' => 0, 'countdb' => $countdb, 'countrepairitre' => $countrepairitr, 'printdate' => $printdate, 'engineerlist' => $engineerlist, 'users' => $users, 'datasr' => $datasr])->setPaper('A4', 'portrait');
